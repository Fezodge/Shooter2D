...
namespace EzGame.Perspective.Planar
{
    public class Object
    {
        ...
        {
            get { return ((Animation != null) ? Animation.Texture() : null); }
            set { Animation = new Animation(value); }
        }

        public Origin Origin
        {
            get { return ((Animation != null) ? Animation.Origin() : Origin.None); }
            set { if (Animation != null) Animation.Override(value); }
        }
        ...
        public Object(Texture2D Texture, Origin Origin = null)
        {
        ...
        public void Cease(params Type[] Filters)
        {
            if (this.Filters != null)
            {
                for (var i = 0; i < this.Filters.Count; i++)
                    if (Filters.Contains(this.Filters[i].GetType()))
                    {
